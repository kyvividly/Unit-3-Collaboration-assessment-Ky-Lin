...
Git is a distributed **Version Control System**, or simply a *control system* that allows you to track the history of your code, and make changes to your code. Github is a company that offers Git repository on its website, [github.com](https://github.com/). Github also stores repositories where your code is stored, and allows for collaboration between developers. Github is the host for Git, and you can use Git for free by going on the website offered by the company.
